module.exports = {
  ...
  "August Derleth": [
    ...
    "Shuttered Room and Other Tales of Horror",
    "Return of Hastur",
  ...
  "Donald Wandrei": [
    ...
    "Ultimate Solution",
    "Martian Sphinx",
    "Eichmann Variations and Other Stories",
  ],
  "Henry S Whitehead": [
    ...
    "Passenger to Bali",
    "Left-Handed Hitting, Etc. of Captain Claybrook",
    "Ghosts and Mohammed Din",
    "People of Pan",
    "Case of the Haitian Lady",
  ],
  "Robert Bloch": [
    "Psycho",
    ...
    "Pleasant Dreams",
    "Opener of the Way",
    "Skull of the Marquis de Sade and Other Stories",
    "Atmospheres",
    "Night of the Ripper",
  ],
  "Evangeline Walton": [
    ...
    "Virgin and the Swine",
    "Above Ker-Is",
    "Dolphin and the Deep",
    "Kings and Lords",
  ],
  "J Sheridan LeFanu": [
    "Carmilla",
  ...
  "Frank Belknap Long": [
    ...
    "Black Druid",
    "Horror from the Hills and Other Weird Tales",
    "Horror from the Outer Beyond",
    "Early Long",
  ],
  "Robert E Howard": [
    "Conan the Barbarian",
  ...
  "H Russell Wakefield": [
    ...
    "Red Lodge",
    "Triumph of Death and Other Stories",
    "Valancourt Book of Horror Stories",
    "Best Horror Stories of H. Russell Wakefield",
    "Horror Horn",
    "Beyond the Pale",
    "Lost Club and Other Stories",
  ],
  "lord dunsany": [
